...
class hiworld(Scene):
    def construct(self):#
        ...
        self.play(text14.animate.scale(1.5),text15.animate.scale(1.5))


        self.play(text14.animate.shift(DOWN*0.5),text15.animate.shift(DOWN*0.50))
        self.play(text14.animate.shift(RIGHT*0.5),text15.animate.shift(LEFT*1.55))
        self.play(Uncreate(text14),Uncreate(text15),Write(text16))
